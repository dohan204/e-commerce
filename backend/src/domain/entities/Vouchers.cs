namespace domain.entities
{
    ...
    public class Voucher : BaseEntity
    {
        ...
        private Voucher() { }
        public Voucher(DiscountTypes discountType, decimal value, decimal minOrder, int maxUsage, DateTime expiryDate)
        {
        ...
        public Voucher(int id, DiscountTypes discountType, decimal value, decimal minOrder, int maxUsage, DateTime expiryDate)
        {
            Id = id;
            Code = Guid.NewGuid().ToString().Substring(0, 12);
            DiscountType = discountType;
        ...
        public static Voucher Create(DiscountTypes discountType, decimal value, decimal minOrder, int maxUsage, DateTime expiryDate)
